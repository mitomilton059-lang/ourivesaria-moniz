...
<section class="jewelry-showcase section" id="joias"><div class="jewelry-head"><div><div class="section-kicker">02 / COLEÇÃO MONIZ</div><h2>Veja nossas<br><em>joias.</em></h2></div><div class="jewelry-copy"><p>Uma seleção real de referências de joalharia em ouro, pesquisadas online e escolhidas pelos seus desenhos de corrente, brilho e acabamento.</p><span>18K · DESENHOS DE CORRENTE</span></div></div><div class="jewelry-stage">${["https://commons.wikimedia.org/wiki/Special:Redirect/file/Curb_chain_in_18K_gold.jpg","https://commons.wikimedia.org/wiki/Special:Redirect/file/Venetian_18K_gold_chain_1.jpg","https://commons.wikimedia.org/wiki/Special:Redirect/file/Spiga_chain_in_18K_gold.jpg","https://commons.wikimedia.org/wiki/Special:Redirect/file/Franco_chain_in_18K_gold.jpg","https://commons.wikimedia.org/wiki/Special:Redirect/file/Faceted_18K_gold_ball_chain.jpg"].map((im,i)=>`<article class="jewel-card jewel-${i+1}" data-tilt><div class="jewel-image"><img src="${im}" alt="${["Corrente curb em ouro 18K","Corrente veneziana em ouro 18K","Corrente spiga em ouro 18K","Corrente franco em ouro 18K","Corrente de elos esféricos em ouro 18K"][i]}" loading="lazy" referrerpolicy="no-referrer"></div><div class="jewel-meta"><span>0${i+1}</span><strong>${["Curb 18K","Veneziana 18K","Spiga 18K","Franco 18K","Ball Chain 18K"][i]}</strong><small>OURO 18K · PEÇA DE REFERÊNCIA</small></div></article>`).join("")}</div><div class="jewelry-marquee"><span>OURO</span><i>✦</i><span>BRILHO</span><i>✦</i><span>PRECISÃO</span><i>✦</i><span>MONIZ</span><i>✦</i><span>OURO</span></div></section>\n<section class="gallery section" id="galeria"><div class="section-head"><div><div class="section-kicker">02 / MONIZ</div><h2>Detalhes que<br><em>falam por si.</em></h2></div><p>Uma seleção das nossas peças e do universo Moniz.</p></div><div class="masonry">${gallery.map((im,i)=>`<figure class="tile tile-${i+1}" data-tilt><img src="${im}" alt="Peça e ambiente Ourivesaria Moniz" loading="lazy"/><span>0${i+1}</span></figure>`).join('')}</div></section>
